...
// devname, ssid, and password are defined in private_settings.h.
// Make sure you copy private_settings.h.sample, rename it, and enter appropriate settings there.
...
int MagicNumber = 223;             //  was 314  change this if you are re-compiling and you dont want to use the ESPROM settings
...
int  capture_interval = 300;       //  milli-seconds between frames
volatile int  total_frames_config = 666;  //  how many frames - length of movie in ms is total_frames x capture_interval
