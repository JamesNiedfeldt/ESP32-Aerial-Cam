...
<br><a href="http://%s/start?framesize=VGA&length=100&interval=100&quality=7&repeat=100&speed=1&gray=0&pir=0&bot=0">http://%s/start?framesize=VGA&length100&interval=100&quality=6&repeat=100&speed=1&gray=0&pir=0&bot=0</a> 
<br><a href="http://%s/start?framesize=VGA&length=100&interval=70&quality=7&repeat=100&speed=1&gray=0&pir=0&bot=0">VGA 15 fps,length100, 1x playback Q10</a>
<br><a href="http://%s/start?framesize=UXGA&length=100&interval=100&quality=10&repeat=100&speed=1&gray=0&bot=0&pir=0">UXGA 10fps, length100 repeat, 1x playback, Q7 </a>
<br><a href="http://%s/start?framesize=UXGA&length=100&interval=300&quality=10&repeat=100&speed=1&gray=0&pir=0&bot=0">UXGA 3 fps, length100, 1x playback,Q7</a>
<br><a href="http://%s/start?framesize=UXGA&length=100&interval=500&quality=10&repeat=100&speed=1&pir=0&bot=0">UXGA 2fps length600 x100 repeat, Q7</a>
<br><a href="http://%s/start?framesize=SVGA&length=100&interval=100&quality=10&repeat=100&speed=1&gray=0&pir=0&bot=0">SVGA 10fps length100 repeat,Q6 </a>
<br><a href="http://%s/start?framesize=UXGA&length=100&interval=500&quality=10&repeat=100&speed=900&gray=0&pir=0&bot=1">UXGA  2fps length100 x100 repeat, Q7</a>
